...
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1, 1], alphaList(1));
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1, 2], alphaList(2));
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [1, 3], alphaList(3));
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2, 1], 1 - alphaList(1));
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2, 2], 1 - alphaList(2));
phenotypeFactor = SetValueOfAssignment(phenotypeFactor, [2, 3], 1 - alphaList(3));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
